...
GtkWidget *gamewin, *vbox, *pbyp, *grview, *vscrollbar, *separator, *canbutton, *speedupbutton, *slowdownbutton, *pbptext, *prpbpbutton, *boxbutton, *dlgBox, *pitcherpicwin, *batterpicwin;
