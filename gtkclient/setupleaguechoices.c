...
SetUpLeagueChoices (gpointer callback_data, guint callback_action, GtkWidget *widget) {
    ...
    gtk_entry_set_text (GTK_ENTRY (inentry), "1901-2025");
        ...
        if (!toggle_ha) {
            ...
            if (teamsw) {
                ...
                gchar *msg[5], NoYrs[256] = "No years to search.", holdt[100], *comma,
                      OneYr[256] = "\nA team with this name occurred in only 1 year.  There needs to be at least 2 teams to form a league.\n\n",
                ...
                if (err) {
                    ...
                    gchar ExMsg[256] = "In excluded years ...", InMsg[256] = "In included years ...",
                          ...
                          InvYr[256] = "A year is not valid (must be 4 positions and must be 1901-2025).";
